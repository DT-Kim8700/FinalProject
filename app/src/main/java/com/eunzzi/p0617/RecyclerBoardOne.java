...
public class RecyclerBoardOne extends Fragment {

    private RecyclerView recycler_board_one = null;
    ...
    public RecyclerBoardOne(String id) {
        this.id = id;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.recycler_board_one, container, false);
    ...
    private void viewSetting(View view){
        recycler_board_one = view.findViewById(R.id.recycler_board_one);

        GridLayoutManager layoutManager = new GridLayoutManager(getActivity(), 1);
        recycler_board_one.setLayoutManager(layoutManager);
    }

    private void adapterSetting(){
        url = ActivityLogin.url_ip + "BoardOne";
        ...
        Response.Listener<String> responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    // 셋팅된 어뎁터를 리싸이클뷰에 셋팅
                    recycler_board_one.setAdapter(adapterBoard);
        ...
        RequestBoardOne requestBoardOne= new RequestBoardOne(id, url, responseListener);
        requestQueue.add(requestBoardOne);
    }
